...
echo ::: Prepare splash :::
java -jar $BUILD_DIR/ImageLabeler-2.0.jar "$VERSION (development)" 462 43 ${BUILD_DIR}/splash-template.bmp ${PROJECT_PATH}/plugins/se.ess.ics.csstudio.product/splash.bmp "European Spallation Source Edition" 19 151 ${PROJECT_PATH}/plugins/se.ess.ics.csstudio.startup.intro/icons/ess96.png 366 140

echo ::: Change about dialog version :::
echo 0=$VERSION > ${PROJECT_PATH}/plugins/se.ess.ics.csstudio.product/about.mappings

echo ::: Change Ansible reference file :::
echo $VERSION > ${PROJECT_PATH}/features/org.csstudio.ess.product.configuration.feature/rootfiles/ess-version.txt
